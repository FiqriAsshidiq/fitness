            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.latihan.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="alat" class="form-control w-full border rounded px-3 py-2" required>
                    </div>
                    
                    <div class="mb-4">
                        <label class="block font-semibold">Kategori Otot</label>
                        <input type="text" name="kategori_otot" class="form-control w-full border rounded px-3 py-2" required>
                    </div>
